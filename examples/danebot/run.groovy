...
String.metaClass.watch = { Map params = [:], Closure closure ->
    ...
    Thread.start {
        Closure clonedClosure = closure.rehydrate(twitterBot, twitterBot, twitterBot)
...
def binding = new Binding(every: every, tweet: tweet, minute: 60000L)
